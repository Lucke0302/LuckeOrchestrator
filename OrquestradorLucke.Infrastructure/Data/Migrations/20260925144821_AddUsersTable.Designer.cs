...
namespace OrquestradorLucke.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260925144821_AddUsersTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrquestradorLucke.Domain.QuotaState", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_quota_states");

                    b.HasIndex("ProviderName")
                        .IsUnique()
                        .HasDatabaseName("ux_quota_states_provider_name");

                    b.ToTable("quota_states", (string)null);
                });

            modelBuilder.Entity("OrquestradorLucke.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
